...
const Comment = () => {
  ...
  return (
    <div className="contact-us-container">
      ...
      <br></br>
      <p>Have a question or want to leave a comment? Use the form below.
     </p>
      <p id="conten">We are not a helpline. We don’t provide advice or respond to personal questions.
